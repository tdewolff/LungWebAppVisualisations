...
this.storeManager.on("renderersInvalidated",_2.hitch(this,function(_19){
this.updateRenderers(_19);
}));
this.storeManager.on("dataLoaded",_2.hitch(this,function(_1a){
this.set("items",_1a);
}));
