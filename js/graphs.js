...
function loadGraph(id, url) {
	...
	req.addEventListener('load', function() {
		...
		xlabel = svg.text("Time").move(GRAPH_WIDTH/2, GRAPH_HEIGHT-GRAPH_PADDING).addClass('xlabel');
		ylabel = svg.text("Lung volume").move(-GRAPH_HEIGHT/2, -GRAPH_PADDING).rotate(-90).addClass('ylabel');
